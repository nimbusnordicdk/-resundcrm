...
export default function OpretLektionPage() {
  ...
  const [pages, setPages] = useState<LessonPage[]>([
    { title: 'Introduktion', content: '', page_number: 1 }
  ])
  ...
  function updateOption(questionIndex: number, optionIndex: number, field: 'text' | 'isCorrect', value: any) {
    ...
    if (field === 'isCorrect' && value === true) {
      // Set all others to false (single correct answer)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success('Lektion oprettet!')
      router.push('/admin/uddannelse')
    } catch (error: any) {
      console.error('Error creating lesson:', error)
      toast.error(error.message || 'Kunne ikke oprette lektion')
    } finally {
      setSaving(false)
    }
  }
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Tilføj indhold og quiz til din nye lektion
          </p>
        </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Publicer med det samme</span>
                  </label>
                </div>
              </div>
            </CardContent>
